...
export const demos: Record<string, Component> = {
  ...
  'signals-tracking': lazy(() => import('../demos/learn/signals-tracking')),
  'signals-equal-writes': lazy(() => import('../demos/learn/signals-equal-writes')),
  ...
  'router-files': lazy(() => import('../demos/learn/router-files')),
  ...
  'ssg-wire': lazy(() => import('../demos/learn/ssg-wire')),
  'tooling-states': lazy(() => import('../demos/learn/tooling-states')),
