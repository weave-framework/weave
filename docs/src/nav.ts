...
const examples: NavSection = {
  ...
  groups: [
    ...
    },
    {
      label: 'Components',
      items: [
        { label: 'Autocomplete', path: '/examples/components/autocomplete' },
        { label: 'Badge', path: '/examples/components/badge' },
        { label: 'Bottom Sheet', path: '/examples/components/bottom-sheet' },
        ...
        { label: 'Form Field', path: '/examples/components/form-field' },
        { label: 'Grid List', path: '/examples/components/grid-list' },
        { label: 'Icon', path: '/examples/components/icon' },
        { label: 'Input', path: '/examples/components/input' },
        { label: 'List', path: '/examples/components/list' },
        { label: 'Menu', path: '/examples/components/menu' },
        { label: 'Menubar', path: '/examples/components/menubar' },
        { label: 'Paginator', path: '/examples/components/paginator' },
        { label: 'Popover Edit', path: '/examples/components/popover-edit' },
        { label: 'Progress Bar', path: '/examples/components/progress-bar' },
        { label: 'Progress Spinner', path: '/examples/components/progress-spinner' },
        ...
        { label: 'Sidenav', path: '/examples/components/sidenav' },
        { label: 'Slide Toggle', path: '/examples/components/slide-toggle' },
        { label: 'Slider', path: '/examples/components/slider' },
        { label: 'Snackbar', path: '/examples/components/snackbar' },
        { label: 'Stepper', path: '/examples/components/stepper' },
        { label: 'Table', path: '/examples/components/table' },
        { label: 'Tabs', path: '/examples/components/tabs' },
        { label: 'Timepicker', path: '/examples/components/timepicker' },
        { label: 'Toolbar', path: '/examples/components/toolbar' },
        { label: 'Tooltip', path: '/examples/components/tooltip' },
        { label: 'Tree', path: '/examples/components/tree' },
      ],
    },
    {
      label: 'Applications',
